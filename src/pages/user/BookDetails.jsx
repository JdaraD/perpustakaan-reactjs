      ...
      <div className="flex flex-col h-full w-[80%]">
        <div className="flex w-full h-80">
          <div className="flex relative justify-center items-center w-[50%] h-full">
            <div className="absolute bg-gray-400 animate-pulse top-2 w-68 h-90 rounded-md shadow-2xl"></div>
          </div>
          <div className="flex relative flex-col w-[50%] h-full p-4 gap-4">
            ...
            <Link to="/read-book">
              <button
                type="button"
                className="absolute bottom-4 left-4 bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 cursor-pointer"
              >
                Read Book
              </button>
            </Link>
            ...
            <div className="flex flex-col justify-between w-[50%] h-full p-4 gap-6">
              ...
              <div className="flex w-full h-auto items-center justify-center">
                <div className="flex justify-center w-[20%] h-full p-4">
                  <div className="bg-gray-500 animate-pulse inset-shadow-amber-50 w-16 h-16 rounded-full shadow-lg"></div>
                </div>
